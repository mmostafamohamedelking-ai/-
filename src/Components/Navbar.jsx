          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center">
              <div className="flex items-center bg-[#161616] rounded-full p-1.5 border border-[#262626]">
                <NavLink className="px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 bg-linear-to-r from-orange-500 to-orange-600 text-white" to="/" aria-current="page">الرئيسية</NavLink>
                <NavLink className="px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 text-neutral-400 hover:text-white" to="/blog">المدونة</NavLink>
                <NavLink className="px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 text-neutral-400 hover:text-white" to="/about">من نحن</NavLink>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <NavLink className="btn-primary text-sm" to="/blog">ابدأ القراءة</NavLink>
            </div>
          ...
          <div className="md:hidden overflow-hidden transition-all duration-300 max-h-0">
            <div className="bg-[#161616] backdrop-blur-xl rounded-2xl p-4 border border-[#262626]">
              <div className="flex flex-col space-y-1">
                <a className="px-4 py-3 rounded-xl text-sm font-medium transition-all duration-300 bg-orange-500/10 text-orange-500 border border-orange-500/30" href="/" aria-current="page">الرئيسية</a>
                <a className="px-4 py-3 rounded-xl text-sm font-medium transition-all duration-300 text-neutral-400 hover:bg-[#1a1a1a] hover:text-white" href="/blog">المدونة</a>
                <a className="px-4 py-3 rounded-xl text-sm font-medium transition-all duration-300 text-neutral-400 hover:bg-[#1a1a1a] hover:text-white" href="/about">من نحن</a>
                <a className="btn-primary text-sm text-center mt-2" href="/blog">ابدأ القراءة</a>
              </div>
            </div>
          </div>
        </div>
